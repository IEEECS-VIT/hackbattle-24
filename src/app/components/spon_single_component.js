...
import yellowCircles from "../../../public/yellow-circles.svg"

function Card({ title, imageSrc }) {
  return (
    <div
      data-aos="zoom-in"
      className="flex flex-col items-center  bg-blue-800 border-black border-4 shadow-[-10px_10px_0_0_#644997] w-[80%] md:w-[60%] lg:w-[40%] h-[75%] "
    >
      ...
      <div className="flex flex-col items-center  w-full h-[20vh] lg:h-[35vh] font-pixeboy text-[3vh] lg:text-[10vh] px-4">
        <Image
          src={imageSrc}
          alt=""
          className="sm:h-[60%] h-[80%] mt-8 pb-8 lg:mt-12"
        />
