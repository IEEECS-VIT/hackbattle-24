  ...
  return (
    <div>
      <div className="relative h-screen w-full hidden lg:block">
        ...
        <p className="z-20 absolute left-1/2 transform -translate-x-1/2 text-white text-[11vh] font-pixeboy glow-text">
          Hackbattle 2024
        </p>

        <div className="flex items-center justify-center h-full">
          <div className="relative flex flex-col border-4 border-black w-[90vw] bg-white shadow-[-20px_20px_0_0_#000000] h-[80vh] z-20 mt-20">
      ...
      <div className="relative h-screen w-full lg:hidden">
        ...
        <p className="z-30 relative top-16  text-white text-[4vh] font-pixeboy glow-text text-center">
          Hackbattle 2024
        </p>
