    ...
    <div className="min-h-screen flex flex-col lg:flex-col xl:flex-row justify-center  gap-10 lg:gap-[17%] items-center ">
      ...
      <div className="w-[120%] xl:w-[35vw] md:w-[80%] lg:w-[100%] h-[140%] lg:h-[65vh] xl:mt-[20%] border-black border-4 rounded-lg shadow-[2vw_2vw_0_0_#8471fb] lg:shadow-[1vw_1vw_0_0_#8471fb] md:shadow-[15px_15px_0_0_#3E8BFF] relative bg-[#ffb7e5] mt-12 lg:mt-0 lg:mb-[30vh]">
        ...
        <div className="flex flex-col relative">
          <textarea className="absolute font-pixeboy text-[4vw]  md:text-[140%] lg:text-[1.3vw] sm:mt-3 bg-white w-[95%] mt-2 ml-1.5 md:w-[95%] lg:w-[95%] h-[80%] md:h-[80%] lg:h-[42vh] md:mt-3 lg:mt-[2vh] md:ml-[3%] lg:ml-[3%] rounded-xl border border-gray-300 px-4 py-2 focus:outline-none overflow-x-auto overflow-y-auto whitespace-nowrap" />
          <div className="border border-[#8471fb] flex-col items-center justify-center md:mb-[3%]   mt-[85%] mb-[2%] md:mt-[25vh] lg:mt-[45vh] "></div>
