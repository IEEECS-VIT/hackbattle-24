...
export default function Card(props) {
    ...
    return (
        <div className="min-h-screen flex flex-col lg:flex-row justify-center gap-10 lg:gap-32 items-center">
            <div className="w-[80vw] xl:w-[35vw] md:w-[65vw] lg:w-[40vw] h-[35vh] lg:h-[45vh] border-black border-4 rounded-lg shadow-[-10px_10px_0_0_#3E8BFF] lg:shadow-[15px_15px_0_0_#3E8BFF] relative bg-red-700">
...
>{`<Github Link>`}
                ...
                <input
    type="text"
    className="absolute bg-white w-[65vw] md:w-[57vw] lg:w-[30vw]  h-[38vw] mt-8 ml-6 md:h-[23vh] lg:h-[29vh] md:mt-6 lg:mt-[3vh] md:ml-6 lg:mr-[15vh] rounded-xl border border-gray-300 px-4 py-2 focus:outline-none"
/>
</div>
 ...
 relative bg-[#ffb7e5] mt-12 lg:mt-0">
...
>{`<DESCRIPTION>`}
                ...
                <input
    type="text"
    className="absolute bg-white w-[70vw] mt-3 ml-3 md:w-[58vw] lg:w-[25vw] h-[40vw] md:h-[20vh] lg:h-[33vh] md:mt-4 lg:mt-[3vh] md:ml-6 lg:ml-[3vh] rounded-xl border border-gray-300 px-4 py-2 focus:outline-none"
/>

                    <div className="border border-[#8471fb] flex items-center justify-center mt-[45vw] md:mt-[23vh] lg:mt-[38vh]"></div>
                    <div className="bg-[#8471fb] border border-gray-500 p-1.5 w-[45vw] mt-1 rounded-lg lg:w-[20vw]"></div>
                </div>
            </div>
        </div>
    );
