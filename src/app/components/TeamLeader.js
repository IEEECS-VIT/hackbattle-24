      ...
      <div className="border-black border-4 shadow-[-10px_10px_0_0_#000000] lg:shadow-[-20px_20px_0_0_#000000] xl:w-[35vw] xl:h-[18vw] bg-[#3E8BFF] w-[75vw] h-[22vh] lg:w-[40vw] sm:h-[28vh]">
        ...
        <div className="border-white border-4 xl:m-6 xl:h-[13vw] sm:h-[20vh] h-[16vh] m-4">
          <div className="float-left">
            <button className="bg-[#FF553E] rounded-2xl border-black border-2 xl:w-[8vw] xl:h-[2vw] lg:w-[12vw] sm:h-[4vh] md:w-[14vw] xl:mt-5 xl:ml-5 lg:mt-4 lg:ml-4 w-[25vw] h-[6vw] mt-3 ml-3">
              Team Leader
            </button>
