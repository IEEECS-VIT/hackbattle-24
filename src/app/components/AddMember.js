            ...
            <div className="border-black border-4 shadow-[-10px_10px_0_0_#000000] lg:shadow-[-20px_20px_0_0_#000000] xl:w-[35vw] xl:h-[18vw] bg-[#848C95] w-[75vw] h-[22vh] lg:w-[40vw] sm:h-[28vh]">
                ...
                <div className="border-white border-4 xl:m-6 xl:h-[13vw] sm:h-[20vh] h-[16vh] m-4">
                    <div className="float-left">
                        ...
                        <p className="font-mercutio xl:text-6xl lg:text-5xl text-white xl:ml-8 xl:mt-4 text-4xl ml-5">Add <br /> Member</p>
                    </div>
                    <div className="float-right">
                        <div className="lg:h-[9vw] lg:w-[9vw] sm:h-[13vw] sm:w-[13vw] h-[18vw] w-[18vw] bg-white rounded-full lg:mt-[5vh] xl:mt-[3.5vh] sm:mt-[4vh] mt-[3vh] mr-[2vw] flex justify-center items-center border-black border-2">
                            <img src="/pacmanaddmember.svg" alt="pacman" className="xl:h-20 xl:w-20 sm:w-16 sm:h-16 w-10 h-10"/>
                        </div>
                    </div>
                </div>
            </div>
